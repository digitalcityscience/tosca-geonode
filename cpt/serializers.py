...
class FormSerializer(serializers.ModelSerializer):
    ...
    feedback_geometry = serializers.JSONField(required=False)
    ...
    )  # Make the campaign field optional
    ...
    def create(self, validated_data):
        ...
        if "feedback_geometry" in validated_data:
            feedback_geometry = validated_data["feedback_geometry"]
            # Convert feedback_geometry (GeoJSON) to string if it's a dict
            if isinstance(feedback_geometry, dict):
                feedback_geometry = json.dumps(feedback_geometry)
            # Save the converted string in validated_data
            validated_data["feedback_geometry"] = feedback_geometry
